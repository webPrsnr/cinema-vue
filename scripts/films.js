...
exports.films = [
    {
        ...
        description: 'Год назад, в канун Рождества, Уинни спасла всю округу от психопата, серийного убийцы. Теперь на грядущее Рождество у девушки только одно желание – не рождаться на этот свет. Ее желание сбывается, и она оказывается в параллельной реальности, в которой убийца все еще на свободе. Ей придется поймать его, чтобы вернуться назад.',
        imgTitle: 'krik',
        dates: [
            {
                date: 1704353994763,
